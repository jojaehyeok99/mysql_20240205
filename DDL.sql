...
-- CREATE : 데이터 구조를 생성하는 명령어
-- CREATE 생성할 구조 구조이름 [... 구조 정의];
-- 명령어 대소문자 구분없음 / 명령어는 대문자 필드는 소문자 - 구분짓기
...
CREATE TABLE example_table (
	-- VARCHAR(문자열 길이) : 가변길이 문자열 데이터 타입 / 인덱스 사용 가능
    string_column VARCHAR(100), -- , 을 이용해 다음 작업하기
    -- TEXT : 장문의 문자열 데이터 타입 / 인덱스 사용 불가능
    text_column TEXT,
    -- INT : 정수 데이터 타입
    int_column INT,
    -- DOUBLE : 실수 데이터 타입
    ...
    -- FLOAT : 실수 데이터 타입
    float_column FLOAT,
    -- BOOLEAN : 논리형 데이터 타입 / tinyint 0 또는 1로 저장
