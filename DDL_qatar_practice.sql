...
-- country (name[가변문자열 30], group[가변문자열1], manager[가변문자열 30], lanking[정수])
...
-- palyer(name[가변문자열 30], age[정수], position[가변문자열 15], pro_team[가변문자열 30], uniform_number[정수], country[가변문자열 30])
